...
go_repository(
    name="com_github_mitchellh_cli", importpath="github.com/mitchellh/cli", tag="v1.0.0"
)
...
# Used by cli
go_repository(
    name="com_github_fatih_color", importpath="github.com/fatih/color", tag="v1.7.0"
)
...
docker_toolchain_configure(
  ...
  # for more details.
  client_config="/Users/smintz/.docker/config.json",
)
