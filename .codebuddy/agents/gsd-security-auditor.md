...
**Verification depth scales with `asvs_level`** (see @/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/gsd-core/references/security-asvs-levels.md for full definitions):
