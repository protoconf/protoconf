...
---
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/.gsd-surface.json`
(sibling to `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/skills/gsd-*/`.
...
(`/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy`), NOT the skills sub-directory (`/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy` as `configDir`. The skill dirs themselves live at
`/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# CodeBuddy — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy}"
SCOPE="global"
...
(i.e. `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/.gsd-surface.json`
Install profile marker: `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/.gsd-profile`
Skill dirs: `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/skills/gsd-*/`
Engine module: `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/go/src/github.com/protoconf/protoconf/.codebuddy/gsd-core/bin/lib/clusters.cjs`
</execution_context>
