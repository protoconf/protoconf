...
// TestIndexBuildRacesParseOne moved to index_build_deadlock_test.go (13-03):
// that file's deadlockCorpus helper already backs an identical race test
// (TestParseAllConcurrentWithParseOneDoesNotDeadlock's D-02 replacement), so
// folding the two into one avoided keeping near-duplicate coverage. See
// 13-03-SUMMARY.md.
