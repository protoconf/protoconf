 ...
 *
 * The Hermes Agent plugin-marketplace channel does NOT go through `npm publish`
 * or bin/install.js. Hermes Agent materializes the git tag tree into its plugin
