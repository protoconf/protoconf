 ...
 * Hermes Agent harness would use to create a 'fresh' parallel worktree. When
...
/**
 * CLI command: write worktree.baseRef = 'head' into <cwd>/.hermes/settings.local.json.
 *
 ...
 * (origin/HEAD) that the Hermes Agent harness would use when creating a 'fresh'
 * parallel worktree.
 *
