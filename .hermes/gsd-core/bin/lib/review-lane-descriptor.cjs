...
exports.REVIEWER_LANES = Object.freeze([
    ...
    },
    {
        ...
        invoke: {
            ...
            // invoking user's global HERMES.md, the project HERMES.md, and Hermes Agent auto-memory —
            // a context asymmetry against the independent-review premise (gemini sees only the
            // assembled prompt; codex runs --ephemeral). Both flags, not just the first: HERMES.md
            ...
            // inside Hermes Agent the claude lane self-skips for independence.
