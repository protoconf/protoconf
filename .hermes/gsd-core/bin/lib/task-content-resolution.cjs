 ...
 * timeout (HERMES.md's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (HERMES.md's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (HERMES.md's Unbounded Subprocesses gauntlet line).
 */
