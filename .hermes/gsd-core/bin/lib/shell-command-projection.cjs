 ...
 * (`opts.hookShell`), not on runtime alone — a single runtime (Hermes Agent)
...
// #166/#580: Hermes Agent on Windows executes hook command strings inside Git
 ...
 * `"$CLAUDE_PROJECT_DIR"/.hermes/hooks/gsd-x.js`). Such a token is ALREADY a
