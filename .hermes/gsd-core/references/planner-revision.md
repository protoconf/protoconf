...
- Active capability / project guidance (HERMES.md, `.hermes/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / HERMES.md rule / plan constraint} | {one line} |
