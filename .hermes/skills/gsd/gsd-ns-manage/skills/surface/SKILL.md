...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/.gsd-surface.json`
(sibling to `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/skills/gsd-*/`.
...
(`/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes`), NOT the skills sub-directory (`/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes` as `configDir`. The skill dirs themselves live at
`/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Hermes Agent — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes}"
SCOPE="global"
...
(i.e. `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/.gsd-surface.json`
Install profile marker: `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/.gsd-profile`
Skill dirs: `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/skills/gsd-*/`
Engine module: `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/go/src/github.com/protoconf/protoconf/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
