...
// hardcode the canonical path `@~/.kilo/gsd-core/...` (references, workflows,
...
// `~/.kilo/gsd-core/` is never created and every @-include resolves to
...
// `~/.kilo/gsd-core/` exists and its immutable subdirs (bin, contexts,
...
// are the directories `@~/.kilo/gsd-core/<subdir>/...` includes point into.
...
/**
 * Ensure the canonical `~/.kilo/gsd-core/` path exposes the bundled subdirs.
 *
