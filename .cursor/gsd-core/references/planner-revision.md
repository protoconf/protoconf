...
- Active capability / project guidance (.cursor/rules/, `.cursor/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / .cursor/rules/ rule / plan constraint} | {one line} |
