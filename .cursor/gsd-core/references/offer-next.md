...
Read and follow `/Users/smintz/go/src/github.com/protoconf/protoconf/.cursor/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
