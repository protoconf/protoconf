 ...
 * timeout (.cursor/rules/'s clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (.cursor/rules/'s Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (.cursor/rules/'s Unbounded Subprocesses gauntlet line).
 */
