...
```
Agent(
  prompt="Read /Users/smintz/go/src/github.com/protoconf/protoconf/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/go/src/github.com/protoconf/protoconf/.opencode/gsd-core/templates/SECURITY.md`
