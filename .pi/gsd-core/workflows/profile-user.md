...
Key references:
- @/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/references/ui-brand.md (display patterns)
- @/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md" "/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/references/user-profiling.md`
...
Reference: @/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/smintz/go/src/github.com/protoconf/protoconf/.pi/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.pi/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/smintz/go/src/github.com/protoconf/protoconf/.pi/CLAUDE.md
```
