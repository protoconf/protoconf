...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.windsurf/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/smintz/go/src/github.com/protoconf/protoconf/.windsurf/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.windsurf/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.windsurf/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.windsurf/agents/gsd-eval-planner.md for instructions.
