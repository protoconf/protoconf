...
- Active capability / project guidance (.windsurf/rules, `.windsurf/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / .windsurf/rules rule / plan constraint} | {one line} |
