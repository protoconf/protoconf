 ...
 * timeout (.devin/rules's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (.devin/rules's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (.devin/rules's Unbounded Subprocesses gauntlet line).
 */
