...
exports.REVIEWER_LANES = Object.freeze([
    ...
    },
    {
        ...
        invoke: {
            ...
            // invoking user's global .devin/rules, the project .devin/rules, and Windsurf auto-memory —
            // a context asymmetry against the independent-review premise (gemini sees only the
            // assembled prompt; codex runs --ephemeral). Both flags, not just the first: .devin/rules
            ...
            // inside Windsurf the claude lane self-skips for independence.
