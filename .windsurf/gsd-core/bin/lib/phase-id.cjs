 ...
 * can never diverge — see .devin/rules's "Generative Fix Divergence" note: this
 ...
 * normalization — .devin/rules's Generative Fix Divergence class):
 ...
 * re-derived per site (.devin/rules's Generative Fix Divergence class).
