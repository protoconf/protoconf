 ...
 *                                                      runtime's config dir (e.g. driving Windsurf from a
...
// prebuilt in the npm tarball. The Windsurf plugin-marketplace channel never
...
// is removed at cutover so it reaches here; an unmigrated command still hits
  ...
  // if argv > 32,767 chars — .devin/rules "Windows ARGV Overflow"). A pin over
