...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.augment/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/smintz/go/src/github.com/protoconf/protoconf/.augment/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.augment/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.augment/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.augment/agents/gsd-eval-planner.md for instructions.
