...
func (UnimplementedProtoconfServiceServer) SubscribeForConfig(*ConfigSubscriptionRequest, grpc.ServerStreamingServer[ConfigUpdate]) error {
	return status.Error(codes.Unimplemented, "method SubscribeForConfig not implemented")
}
...
func RegisterProtoconfServiceServer(s grpc.ServiceRegistrar, srv ProtoconfServiceServer) {
	// If the following call panics, it indicates UnimplementedProtoconfServiceServer was
...
func (UnimplementedProtoconfMutationServiceServer) MutateConfig(context.Context, *ConfigMutationRequest) (*ConfigMutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MutateConfig not implemented")
}
...
func RegisterProtoconfMutationServiceServer(s grpc.ServiceRegistrar, srv ProtoconfMutationServiceServer) {
	// If the following call panics, it indicates UnimplementedProtoconfMutationServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterProtoconfMutationReportServiceServer(s grpc.ServiceRegistrar, srv ProtoconfMutationReportServiceServer) {
	// If the following call panics, it indicates UnimplementedProtoconfMutationReportServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedProtoconfCompileServer) CompileFiles(*CompileRequest, grpc.ServerStreamingServer[CompileResponse]) error {
	return status.Error(codes.Unimplemented, "method CompileFiles not implemented")
}
...
func RegisterProtoconfCompileServer(s grpc.ServiceRegistrar, srv ProtoconfCompileServer) {
	// If the following call panics, it indicates UnimplementedProtoconfCompileServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
