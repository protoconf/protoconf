...
- Active capability / project guidance (AGENTS.md, `.codex/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / AGENTS.md rule / plan constraint} | {one line} |
