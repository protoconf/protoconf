...
```
Agent(
  prompt="Read /Users/smintz/go/src/github.com/protoconf/protoconf/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/go/src/github.com/protoconf/protoconf/.codex/gsd-core/templates/SECURITY.md`
