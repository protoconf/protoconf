...
- Active capability / project guidance (QWEN.md, `.qwen/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / QWEN.md rule / plan constraint} | {one line} |
