 ...
 *                                                      runtime's config dir (e.g. driving Qwen Code from a
...
// prebuilt in the npm tarball. The Qwen Code plugin-marketplace channel never
...
// is removed at cutover so it reaches here; an unmigrated command still hits
  ...
  // if argv > 32,767 chars — QWEN.md "Windows ARGV Overflow"). A pin over
