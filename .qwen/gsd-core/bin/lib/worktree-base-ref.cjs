 ...
 * Qwen Code harness would use to create a 'fresh' parallel worktree. When
...
/**
 * CLI command: write worktree.baseRef = 'head' into <cwd>/.qwen/settings.local.json.
 *
 ...
 * (origin/HEAD) that the Qwen Code harness would use when creating a 'fresh'
 * parallel worktree.
 *
