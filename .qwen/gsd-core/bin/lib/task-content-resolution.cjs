 ...
 * timeout (QWEN.md's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (QWEN.md's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (QWEN.md's Unbounded Subprocesses gauntlet line).
 */
