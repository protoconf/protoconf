...
exports.REVIEWER_LANES = Object.freeze([
    ...
    },
    {
        ...
        invoke: {
            ...
            // invoking user's global QWEN.md, the project QWEN.md, and Qwen Code auto-memory —
            // a context asymmetry against the independent-review premise (gemini sees only the
            // assembled prompt; codex runs --ephemeral). Both flags, not just the first: QWEN.md
            ...
            // inside Qwen Code the claude lane self-skips for independence.
