 ...
 * (`opts.hookShell`), not on runtime alone — a single runtime (Qwen Code)
...
// #166/#580: Qwen Code on Windows executes hook command strings inside Git
 ...
 * `"$CLAUDE_PROJECT_DIR"/.qwen/hooks/gsd-x.js`). Such a token is ALREADY a
