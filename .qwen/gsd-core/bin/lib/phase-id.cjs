 ...
 * can never diverge — see QWEN.md's "Generative Fix Divergence" note: this
 ...
 * normalization — QWEN.md's Generative Fix Divergence class):
 ...
 * re-derived per site (QWEN.md's Generative Fix Divergence class).
