...
// build failure must degrade to a blank line rather than break Qwen Code's
...
// Qwen Code's per-render statusline hook. Scoped to the spawned-as-a-script
 ...
 * cache-read, and output tokens (the same total Qwen Code's /context shows).
...
/**
 * Collapse the verbose " (… context)" model-name suffix Qwen Code sends for
