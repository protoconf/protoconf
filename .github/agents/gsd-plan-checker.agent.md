...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain copilot-instructions.md mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks copilot-instructions.md requires"
...
@.github/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a copilot-instructions.md convention, or an active capability constraint. If
