...
function cmdGenerateClaudeProfile(cwd, options, raw) {
    ...
    // hardcoded .github/copilot-instructions.md. Mirrors the #3163 fix applied to
    ...
    //   write to copilot-instructions.md even if a prior the agent setup left claude_md_path).
    let config = {};
    try {
