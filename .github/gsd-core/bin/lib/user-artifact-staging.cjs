...
// "KNOWN DEFECTS" precedent in copilot-instructions.md's "Unbounded Subprocesses" row);
...
function recoverOrphanedUserArtifacts(stagingRoot, configDir, opts = {}) {
    ...
    for (const entry of entries) {
        ...
        try {
            ...
            // WRITE destination, e.g. nix-darwin's `.github` symlink). This is a
...
module.exports = {
    ...
    // #2875 defect fix: exported for a fast-check property test (copilot-instructions.md
