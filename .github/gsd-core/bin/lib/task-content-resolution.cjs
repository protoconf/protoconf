 ...
 * timeout (copilot-instructions.md's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (copilot-instructions.md's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (copilot-instructions.md's Unbounded Subprocesses gauntlet line).
 */
