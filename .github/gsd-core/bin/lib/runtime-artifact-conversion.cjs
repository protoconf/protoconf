 ...
 * Path mappings depend on install mode:
 *   Global: .github/skills/ → ~/.gemini/config/skills/ (#3738),
 *          .github/ → ~/.gemini/antigravity/, ./.github/ → ./.agents/
...
function _applyRuntimeRewrites(content, runtime, pathPrefix, isGlobal = false, attribution = undefined) {
    ...
    switch (runtime) {
        ...
        case 'zcode':
            ...
            // `${_GSD_RUNTIME_ROOT}/.github/…` matches none of these regexes and
...
function applyAgentPathRewrites(content, runtime, pathPrefix) {
    ...
    // `@.github/...` include in a global the agent install shipped as `@$HOME/...`
    ...
    // fixes `@.github/x` and leaves a bare `@.github` broken. The
