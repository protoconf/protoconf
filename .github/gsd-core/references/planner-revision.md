...
- Active capability / project guidance (copilot-instructions.md, `.github/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / copilot-instructions.md rule / plan constraint} | {one line} |
