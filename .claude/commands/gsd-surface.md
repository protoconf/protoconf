...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/.gsd-surface.json`
(sibling to `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/skills`).
...
`/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/.gsd-surface.json`
Install profile marker: `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/.gsd-profile`
Skill dirs: `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/skills/gsd-*/`
Engine module: `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
