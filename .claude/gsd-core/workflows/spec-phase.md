...
ones). Reference: @/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/smintz/go/src/github.com/protoconf/protoconf/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/templates/spec.md.
