...
```
Agent(
  prompt="Read /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/templates/VALIDATION.md`
