...
<required_reading>
@/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/references/ai-frameworks.md
@/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/agents/gsd-eval-planner.md for instructions.
