...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/smintz/go/src/github.com/protoconf/protoconf/.claude
                  → checks /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core
                  → writes to /Users/smintz/go/src/github.com/protoconf/protoconf/.claude/gsd-core/hooks/
