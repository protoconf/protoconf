# .trae/rules/rules.md Template

Template for project-root `.trae/rules/rules.md` — auto-generated by `gsd-tools generate-claude-md`.
...
.trae/rules/rules.md file and no profile section exists yet.
