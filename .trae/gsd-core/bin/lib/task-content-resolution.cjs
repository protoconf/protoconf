 ...
 * timeout (.trae/rules/rules.md's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (.trae/rules/rules.md's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (.trae/rules/rules.md's Unbounded Subprocesses gauntlet line).
 */
