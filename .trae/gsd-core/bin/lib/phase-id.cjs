 ...
 * can never diverge — see .trae/rules/rules.md's "Generative Fix Divergence" note: this
 ...
 * normalization — .trae/rules/rules.md's Generative Fix Divergence class):
 ...
 * re-derived per site (.trae/rules/rules.md's Generative Fix Divergence class).
