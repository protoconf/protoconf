...
// generative-fix divergence .trae/rules/rules.md warns about. Collapsed onto core-utils'
...
// silently disagree with it after a future change here (.trae/rules/rules.md's
