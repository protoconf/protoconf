...
// "KNOWN DEFECTS" precedent in .trae/rules/rules.md's "Unbounded Subprocesses" row);
...
module.exports = {
    ...
    // #2875 defect fix: exported for a fast-check property test (.trae/rules/rules.md
