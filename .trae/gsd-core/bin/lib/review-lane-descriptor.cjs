...
exports.REVIEWER_LANES = Object.freeze([
    ...
    },
    {
        ...
        invoke: {
            ...
            // invoking user's global .trae/rules/rules.md, the project .trae/rules/rules.md, and Trae auto-memory —
            // a context asymmetry against the independent-review premise (gemini sees only the
            // assembled prompt; codex runs --ephemeral). Both flags, not just the first: .trae/rules/rules.md
            ...
            // inside Trae the claude lane self-skips for independence.
