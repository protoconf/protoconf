 ...
 *                                                      runtime's config dir (e.g. driving Trae from a
...
// prebuilt in the npm tarball. The Trae plugin-marketplace channel never
...
// is removed at cutover so it reaches here; an unmigrated command still hits
  ...
  // if argv > 32,767 chars — .trae/rules/rules.md "Windows ARGV Overflow"). A pin over
