...
- Active capability / project guidance (.trae/rules/rules.md, `.trae/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / .trae/rules/rules.md rule / plan constraint} | {one line} |
