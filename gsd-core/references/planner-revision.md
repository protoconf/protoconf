...
- Active capability / project guidance (.clinerules, `.cline/skills/`, `.agents/skills/`)
...
|-------|-------------------|----------------|-------------------------------|
| {dimension}/{plan} | {property} | {locked decision D-nn / .clinerules rule / plan constraint} | {one line} |
