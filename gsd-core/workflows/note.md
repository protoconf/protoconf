...
- **Global scope**: `/Users/smintz/go/src/github.com/protoconf/protoconf/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/smintz/go/src/github.com/protoconf/protoconf/notes/`)
...
2. Glob `/Users/smintz/go/src/github.com/protoconf/protoconf/notes/*.md` (if directory exists) — global notes
...
Global (/Users/smintz/go/src/github.com/protoconf/protoconf/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/smintz/go/src/github.com/protoconf/protoconf/notes/` — works in any directory
