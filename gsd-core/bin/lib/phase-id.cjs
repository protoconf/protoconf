 ...
 * can never diverge — see .clinerules's "Generative Fix Divergence" note: this
 ...
 * normalization — .clinerules's Generative Fix Divergence class):
 ...
 * re-derived per site (.clinerules's Generative Fix Divergence class).
