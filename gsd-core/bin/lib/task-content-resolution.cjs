 ...
 * timeout (.clinerules's clock-seam rule).
 *
 ...
 * the other fails a test instead of drifting quietly (.clinerules's Generative
 * Fix Divergence rule).
 */
 ...
 * than hanging the caller (.clinerules's Unbounded Subprocesses gauntlet line).
 */
