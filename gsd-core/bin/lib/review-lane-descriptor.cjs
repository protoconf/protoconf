...
exports.REVIEWER_LANES = Object.freeze([
    ...
    },
    {
        ...
        invoke: {
            ...
            // invoking user's global .clinerules, the project .clinerules, and Cline auto-memory —
            // a context asymmetry against the independent-review premise (gemini sees only the
            // assembled prompt; codex runs --ephemeral). Both flags, not just the first: .clinerules
            ...
            // inside Cline the claude lane self-skips for independence.
