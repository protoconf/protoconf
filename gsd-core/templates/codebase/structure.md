...
- Usage: Reference from command with `@/Users/smintz/go/src/github.com/protoconf/protoconf/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/smintz/go/src/github.com/protoconf/protoconf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/smintz/go/src/github.com/protoconf/protoconf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
